...
///
/// This class is responsible for handling location updates and providing the necessary data for the augmented reality feature. It conforms to the NSObject class.
  ...
  func viewForAuthorizationStatus() -> some View {
    ...
    case .notDetermined:
      ...
      description = """
        ...
        """
      button = Button(
        "Enable Precise Location Access",
        action: {
