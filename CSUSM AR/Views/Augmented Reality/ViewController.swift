...
//  CSUSM AR
//
//  Created by Salman Burhan on 9/25/23.
//
...
class ViewController: UIViewController {
    ...
    func setUpGARSession() {
        ...
        do {
            garSession = try GARSession(apiKey: kARCoreAPIKey, bundleIdentifier: nil)
        }
        catch {
    ...
    func updateLocalizationState() {
        ...
        print("updated localization state ==> \(self.localizationState)")
    }
    ...
    func renderStreetscapeGeometries() {
        ...
        self.streetscapeGeometryParentNode.isHidden = self.localizationState == .localized ? false : true
